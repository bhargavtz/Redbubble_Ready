...
const GenerateRedbubbleMetadataInputSchema = z.object({
    artworkDataUri: z
        .string()
        .describe("A photo of the artwork, as a data URI that must include a MIME type and use Base64 encoding. Expected format: 'data:<mimetype>;base64,<encoded_data>'."),
});
...
export async function generateRedbubbleMetadata(input) {
